...
function HeroBanner() {
  return (
    <main>
      <div className="relative w-full flex flex-col gap-4 items-center justify-center h-[90vh] md:h-[70vh] lg:h-screen overflow-hidden px-4 md:px-7.5 lg:px-12.5">
        {/* Canvas spotlight background — 'dk' for dark mode, 'lt' for light */}
        <Spotlight mode="dk" />

        {/* Content sits above the canvas via z-index */}
        <div className="relative z-10 flex flex-col items-center gap-4 text-center py-8 pt-30">
          ...
          <p className="text-primary dark:text-text-dark text-text-light w-73 sm:w-85 md:w-100 lg:w-150">
